...
export default function Home() {
  ...
  const runDemo = (type: "encapsulation" | "inheritance" | "polymorphism") => {
    ...
    window.setTimeout(() => document.getElementById("pbo-console")?.scrollIntoView({ behavior: "smooth", block: "center" }), 40);
  };
