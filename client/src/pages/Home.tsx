...
export default function Home() {
  ...
  const runDemo = (type: "encapsulation" | "inheritance" | "polymorphism") => {
    ...
    window.setTimeout(() => document.getElementById(`pbo-output-${type}`)?.scrollIntoView({ behavior: "smooth", block: "center" }), 80);
  };
